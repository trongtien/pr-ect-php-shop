...
<div class="col-lg-12">
    ...
    <li><i class="fa fa-th-list"></i>List To Void</li>
    </ol>
</div>
</div>
<div class="row">
...
<table class="table table-striped table-advance table-hover">
    ...
    <th></th>
    <?php
    $sql_select_donhang = mysqli_query($conn,"SELECT * FROM donhang inner join member on donhang.userid = member.userid where donhang.status = 3 ");
    $i=0;
    ...
    <td>
        <a  
            class="<?php echo $row_donhang['status']==3 ? 'btn btn-danger':''?>"
            >
            <?php  echo $row_donhang['status']==3 ? 'Khách hàng đã hủy' : ''?>
        </a>
    </td>
    <th>
    <div class="btn-group">
    ...
    <div class="btn-group">
    <a class="btn btn-danger" href="danhsachtovoid.php?id=<?php echo $row_donhang['iddonhang'] ?>">Chi tiết</i></a>
    </div>
    </th>
    </tr>
    <?php
